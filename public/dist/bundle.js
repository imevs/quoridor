...
define("views/InfoView", ["require", "exports", "underscore", "views/GameObject"], function (require, exports, underscore_4, GameObject_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class InfoView extends GameObject_4.GameObject {
        ...
        render() {
            const me = this;
            me.$el.html(underscore_4.default.template(me.template, { variable: 'data' })(me.model.toJSON()));
        ...
        drawRemainingFences() {
            ...
            (0, underscore_4.default)(me.model.get('fences')).each((fenceCount, index) => {
                let x = x0, y = y0;
                ...
                (0, underscore_4.default)(fenceCount).times((i) => {
        ...
        displayPlayer(index, dx, dy, text) {
            dx += 70;
            if (underscore_4.default.isUndefined(index) || index < 0) {
                return;
            }
...
define("views/TimerView", ["require", "exports", "underscore", "backbone"], function (require, exports, underscore_5, backbone_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class TimerView extends backbone_3.View {
        ...
        render() {
            const me = this;
            me.$el.html(underscore_5.default.template(me.template, { variable: 'data' })(me.model.toJSON()));
            me.$el.find('.move').click(() => {
                me.trigger('click');
            });
            return this;
...
define("models/TurnModel", ["require", "exports", "underscore", "models/BackboneModel"], function (require, exports, underscore_6, BackboneModel_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class TurnsCollection extends BackboneModel_3.BackboneCollection {
        constructor() {
            super(...arguments);
    ...
    class GameHistoryModel extends BackboneModel_3.BackboneModel {
        defaults() {
            return {
                playerNames: [],
            };
        ...
        getPlayerPositions() {
            ...
            (0, underscore_6.default)(underscore_6.default.range(playersCount)).each(index => {
                ...
                const playerInfo = underscore_6.default.last(playerPositions);
                if (playerInfo) {
        ...
        at(index) {
            ...
            (0, underscore_6.default)(turns).each(value => {
                result.push(value + '');
            });
            return result.join(' ');
        }
...
define("views/GameHistoryView", ["require", "exports", "backbone", "underscore"], function (require, exports, backbone_4, underscore_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class GameHistoryView extends backbone_4.View {
        ...
        render() {
            ...
            this.$el.html(underscore_7.default.template(this.template, { variable: 'data' })(data));
            return this;
        }
    }
...
define("models/BoardValidation", ["require", "exports", "underscore", "models/PlayerModel", "models/FenceModel", "models/utils", "models/BoardModel"], function (require, exports, underscore_13, PlayerModel_3, FenceModel_3, utils_4, BoardModel_1) {
    ...
    class BoardValidation extends BoardModel_1.BoardModel {
        ...
        isOtherPlayerAndFenceBehindHimVertical(pos1, pos2, busyFences) {
            ...
            const result = sibling1 && (wallY === -1 || wallY === 8 || (0, underscore_13.default)(busyFences).findWhere({
                x: playerX,
                y: wallY,
                orientation: 'H'
            }));
        ...
        isOtherPlayerAndFenceBehindHimHorizontal(pos1, pos2, busyFences) {
            ...
            const result = sibling1 && (wallX === -1 || wallX === 8 || (0, underscore_13.default)(busyFences).findWhere({
                x: wallX,
                y: playerY,
                orientation: 'V'
            }));
        ...
        hasWallsOrPawnsNear(wall) {
            ...
            const result = !!underscore_13.default.intersection(busyFences, nearestWalls).length;
            return result;
        }
        ...
        getNearestWalls(wall) {
            ...
            const all = (0, underscore_13.default)(this._getNearestWalls(wall).concat(this._getNearestWalls(siblingWall)));
            const all2 = all.without(all.findWhere(wall), all.findWhere(siblingWall));
            const unique = underscore_13.default.uniq(all2, a => {
                return a.type + a.x + a.y;
            });
            return (0, underscore_13.default)(unique).filter(item => {
        ...
        copy() {
            ...
            board.fences = new FenceModel_3.FencesCollection(this.fences.toJSON(), { model: FenceModel_3.FenceModel });
            board.players = new PlayerModel_3.PlayersCollection(this.players.toJSON(), { model: PlayerModel_3.PlayerModel });
...
define("models/urlParser", ["require", "exports"], function (require, exports) {
    ...
    const parseUrl = (url) => {
        let queryString = url, result = {}, i, s, seg;
